...
const DownloadSamasynch = () => {
  return (
    <div className="mx-auto w-full rounded-lg border-0 bg-gradient-to-b from-white to-[#EDEDED] px-4 py-6 md:max-w-172 md:py-12 lg:max-w-220">
      <div className="flex flex-col items-center text-mainmaroon md:gap-2">
        ...
        <a
          className="font-formular-mono mt-3 cursor-pointer rounded-sm bg-mainmaroon px-4 py-1.5 text-center text-xs tracking-wide text-white md:rounded-xl md:px-12 md:py-3 md:text-sm"
