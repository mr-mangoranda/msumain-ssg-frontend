  ...
  return (
    <div className="pointer-events-none fixed top-0 z-50 w-full px-4 py-4 sm:px-6 lg:px-10 xl:px-24 2xl:px-40">
      <div className="relative lg:hidden">
        <div
          className={`flex h-14 items-center justify-start px-4 sm:px-6 ${isMobileMenuOpen ? "bg-mainmaroon rounded-t-xl" : ""
            }`}
        >
          <button
            onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
            className={`pointer-events-auto cursor-pointer p-2 transition-colors ${isMobileMenuOpen ? "text-white" : "text-white"
              }`}
        ...
        {isMobileMenuOpen && (
          <div className="bg-mainmaroon pointer-events-auto absolute top-14 right-0 left-0 z-40 mt-0 overflow-y-auto rounded-b-4xl px-10 pb-6 text-white shadow-xl">
      ...
      <div className="hidden lg:block">
        <div className="mx-auto max-w-7xl">
          <div className="bg-mainmaroon/95 border-gold1/90 pointer-events-auto flex h-14 items-center justify-between rounded-full border py-7 lg:px-4 xl:px-8">
            ...
            <div className="3xl:space-x-32 flex flex-nowrap items-center space-x-20 lg:space-x-16 2xl:space-x-20">
              ...
              <div className="group relative inline-block align-middle">
                ...
                <div className="absolute top-full left-1/2 z-10 hidden -translate-x-1/2 group-hover:block">
                  <div className="border-mainmaroon mt-4 min-w-48 rounded-b-md border bg-white py-1 shadow-lg">
                    {offices.map((o) => (
                      <Link
                        key={o.href}
                        href={o.href}
                        className="font-formular-mono text-mainmaroon hover:bg-mainmaroon block px-4 py-2 hover:text-white"
                      >
                        {o.label}
                      </Link>
                    ))}
              ...
              <div className="group relative inline-block align-middle">
                ...
                <div className="absolute top-full left-1/2 z-10 hidden -translate-x-1/2 group-hover:block">
                  <div className="border-mainmaroon mt-4 min-w-60 rounded-b-md border bg-white py-1 shadow-lg">
                    {infoPortal.map((i) => (
                      <Link
                        key={i.href}
                        href={i.href}
